...
function App() {
  ...
  return (<div id="drum-machine" className="bg-info min-vh-100 text-white">
    <div className="text-center">
      ...
      {audioClips.map((clip) => (
        <Actions key={clip.id} clip = {clip} volume={volume} setRecording ={setRecording}/>
      ))}
...
function Actions({clip, volume, setRecording}){
  ...
  const hit = () => {
    const audioVar = document.getElementById(clip.keyTrigger);
    setActive(true);
  ...
  return (<div  onClick = {hit} id="drum"
